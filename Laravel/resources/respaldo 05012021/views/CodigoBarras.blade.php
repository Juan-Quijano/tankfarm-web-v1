...
<head>
    ...
    * {
    ...
    @font-face {
        ...
        url("{{url('/')}}/dashboard/dist/fonts/ds-digital.woff") format('woff'),
        url("{{url('/')}}/dashboard/dist/fonts/ds-digital.ttf") format('truetype')
    }
...
var IPSERVIDOR = "{{url('/')}}".replace(":83/TankFarmWeb2", "");
//var IPSERVIDOR = "{{url('/')}}".replace("/ScadaBMW", "");
