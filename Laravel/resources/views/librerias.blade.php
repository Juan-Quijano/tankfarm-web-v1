...
<script src="{{url('/')}}/js/codigoBarrasJS.js"></script>

<script src="{{url('/')}}/vendors/google-code-prettify/src/prettify.js"></script>
<!-- jQuery Tags Input <script src="{{url('/')}}/vendors/jquery.hotkeys/jquery.hotkeys.js"></script><script src="{{url('/')}}/vendors/bootstrap-wysiwyg/js/bootstrap-wysiwyg.min.js"></script><script src="{{url('/')}}/vendors/bootstrap-wysiwyg/js/bootstrap-wysiwyg.min.js"></script>-->
<script src="{{url('/')}}/vendors/jquery.tagsinput/src/jquery.tagsinput.js"></script>
<!-- Switchery -->
<script src="{{url('/')}}/vendors/switchery/dist/switchery.min.js"></script>
<!-- Select2 -->
<script src="{{url('/')}}/vendors/select2/dist/js/select2.full.min.js"></script>
<script src="{{url('/')}}/dist/vendors/bower_components/jquery.steps/build/jquery.steps.min.js"></script>
<!-- Parsley -->

<!-- Autosize <script src="{{url('/')}}/dist/js/form-wizard-data.js"></script>-->
