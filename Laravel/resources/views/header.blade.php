...
<head>
    ...
    @font-face {
        ...
        src: url("{{url('/')}}/dashboard/assets/fonts/glyphicons-halflings-regular.eot");
        src: url("{{url('/')}}/dashboard/assets/fonts/glyphicons-halflings-regular.eot?#iefix") format("embedded-opentype"),
        url("{{url('/')}}/dashboard/assets/fonts/glyphicons-halflings-regular.woff") format("woff"),
        url("{{url('/')}}/dashboard/assets/fonts/glyphicons-halflings-regular.ttf") format("truetype"),
        url("{{url('/')}}/dashboard/assets/fonts/glyphicons-halflings-regular.svg#glyphicons-halflingsregular") format("svg");
    }
                        ...
                        <ul class=" navbar-right">
                            <li class="nav-item dropdown open" style="padding-left: 15px;">
                                ...
                                <div class="dropdown-menu dropdown-usermenu pull-right"
                                    ...
                                    <a class="dropdown-item" href="{{url('/cerrarSesion')}}"><i
