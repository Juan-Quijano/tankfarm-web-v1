            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        ...
                        <div class="form-check form-check-inline ">
                            <input class="form-check-input " type="checkbox" id="ENDTIME" value="optiont">
...
var endtime = document.getElementById("ENDTIME").checked;
...
var arrayN = ['ID','PROFILE','TYPEPROFILE','COMPANY', 'LOADING DAYS', 'START TIME', 'END TIME','MAXLOADER','AMOUNTDAY', 'AMOUNTWEEK', 'AMOUNTMONTH', 'STATION', 'PRODUCT', 'STATUS'];
var detail = [
    [
        {
            text: 'ID',
...
var status = document.getElementById("STATUS").checked;
    ...
    for (var i = 0; i < objPV.length; i++) {
        ...
        if((endtime) ){
            tr.append(
            "<td class='(endtime) ' style='text-align: center;background: #dddede;border: 1px solid black;font-family:BMWTypeCondensedRegular;'>" +
            convertHoras(objPV[i].hrafin) + "</td>");
        }else{
            tr.append(
            "<td class='(endtime) ' style='text-align: center;background: #fff;border: 1px solid black;font-family:BMWTypeCondensedRegular;'> " +"" + "</td> ");
        }
