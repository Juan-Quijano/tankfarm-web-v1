       ...
       if (objVehicles[i].codgas == "2") {
        ...
        if (pos == 0) {
            ...
            Tabla_Vehicles.row.add([
                String(quitarCaracteres(objVehicles[i].company)),
                String(nombrePerfil),
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.Status == "OK") {
                            swal.fire("Good Job!", "vehicle disabled succefull!", "success")
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.Status == "OK") {
                            swal.fire("OK! VEHICLE UPDATED SUCCESSFULLY!", {
                                icon: "success",
                            });
                            UpdateContenedor('Vehicles');
                        } else {
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.Status == "OK") {
                            swal.fire("GOOD JOB!", "VEHICLE DISABLED SUCCESSFULLY!", "success")
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.Status == "OK") {
                            swal.fire("GOOD JOB!", "VEHICLE ENABLED SUCCESSFULLY!", "success")
...
for (let index = 0; index < objVehicles.length; index++) {
    if (company) {
        datos.push({
            text: quitarCaracteres(objVehicles[index].company),
            style: 'tableText'
        });
    }else{
        datos.push({
    ...
    if (profile) {
        datos.push({
            text: quitarCaracteres(objVehicles[index].profileName),
            style: 'tableText'
        });
    }else{
        datos.push({
...
var status = document.getElementById("STATUS").checked;
    ...
    for (var i = 0; i < objVehicles.length; i++) {
        ...
        if(company){
            ...
            quitarCaracteres(objVehicles[i].company) + "</td> ");
        }else{
            tr.append(
