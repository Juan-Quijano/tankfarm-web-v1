                        ...
                        <ul class="nav nav-tabs md-tabs" id="myTabMD" role="tablist">
                            <li class="nav-item waves-effect waves-light">
                                <a class="nav-link active" id="home-tab-md" data-toggle="tab" href="#home-md" role="tab"
                                    aria-controls="home-md" aria-selected="true">Diesel</a>
                            </li>
                        ...
                        <thead>
                            <tr role="row">
                                <th class="sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1"
                                    ...
                                    aria-label="ID: activate to sort column descending">NROTRN</th>
...
function llenarTabla2() {
    ...
    var colorboton = "";
    var statusVehicle = "";
    Tabla_DespachosTF.clear().draw();

    var htmlBotonStatus = "";


    for (var i = 0; i < ArrayFechasTF.length; i++) {



        if (pos == 0) {
            Tabla_DespachosTF.row.add([
                String(ArrayTrnTF[i]),
                String(ArrayFechasTF[i]),
                String(ArrayDieselTF[i]),
    ...
    Tabla_DespachosTF.column('1:visible').order('desc').draw()
...
function init_DataTables() {
    ...
    var handleDataTableButtons = function() {
        ...
        if ($("#datatable-buttons2").length) {
            Tabla_DespachosTF = $("#datatable-buttons2").DataTable({
                dom: "Blfrtip",
