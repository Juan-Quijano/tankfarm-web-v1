                            ...
                            <tbody>
                                <div class="text-right">
                                    <button id="seeAll" class="btn btn-warning" type="button"> <span id="icono"
                                            class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> SEE ALL|</button>
...
* Tiene que  tener al menos 1 número en su estructura." data-original-title="Ayuda"><img src="{{url('/')}}/images/info_208px.png" alt="Girl in a jacket" width="30px" height="30px"></a>
    ...
    for (var i = 0; i < objUsers.length; i++) {
        ...
        if (pos == 0) {
            ...
            Tabla_Usuarios.row.add([
                ...
                String(quitarCaracteres(objUsers[i].Nombre) + " " + quitarCaracteres(objUsers[i].LastName)),
                String(quitarCaracteres(objUsers[i].UserName)),
                String(quitarCaracteres(objUsers[i].Rol) != null ? quitarCaracteres(objUsers[i].Rol) : ""),
                String(htmlIdioma),
                String(objUsers[i].Telefono),
                String(objUsers[i].Correo),
                String(quitarCaracteres(objUsers[i].Compania)),
                String(objUsers[i].Departamento),
                String(quitarCaracteres(objUsers[i].Manager) + " " + quitarCaracteres(objUsers[i].LastName)),
                String(colorStatus),
...
function MostrarDivEditar(pos, id) {
    ...
    $('#ConfirmPassword').val(objUsers[pos].Password);
...
function validaciones() {
    ...
    if (band2 == 0) {
        ...
        if (valcorreo == true) {
            if($("#Spanpassword").text()=="Strong" ||  $("#Spanpassword").text()=="" ){
                SetuSERCatalog();
            }else{
            ...
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.Status == "OK") {
                            swal.fire("OK!", "USER UPDATED SUCCESSFULLY", "success");
                            UpdateContenedor('users');
                        } else {
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.Status == "OK") {
                            swal.fire("GOOD JOB!", "USER DISABLED SUCCESSFULLY!", "success")
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.Status == "OK") {
                            swal.fire("GOOD JOB!", "USER ENABLED SUCCESSFULLY!", "success")
...
for (let index = 0; index < objUsers.length; index++) {
    ...
    if (name) {
        datos.push({
            text: quitarCaracteres(objUsers[index].Nombre) + " " + quitarCaracteres(objUsers[index].LastName),
            style: 'tableText'
        });
    }else{
        datos.push({
    ...
    if (user) {
        datos.push({
            text: quitarCaracteres(objUsers[index].UserName),
            style: 'tableText'
        });
    }else{
        datos.push({
    ...
    if (role) {
        datos.push({
            text: quitarCaracteres(objUsers[index].Rol),
            style: 'tableText'
        });
    }else{
        datos.push({
    ...
    if (company) {
        datos.push({
            text: quitarCaracteres(objUsers[index].Compania),
            style: 'tableText'
        });
    }else{
        datos.push({
    ...
    if (manager) {
        datos.push({
            text: quitarCaracteres(objUsers[index].Manager) + " " + quitarCaracteres(objUsers[index].SecondLastName),
            style: 'tableText'
        });
    }else{
        datos.push({
...
var status = document.getElementById("STATUS").checked;
    ...
    for (var i = 0; i < objUsers.length; i++) {
        ...
        if(name){
            ...
            quitarCaracteres(objUsers[i].Nombre) + " " + quitarCaracteres(objUsers[i].LastName) + "</td>");
        }else{
            tr.append(
        ...
        if(user){
            ...
            quitarCaracteres(objUsers[i].UserName) + "</td>");
        }else{
            tr.append(
        ...
        if(role){
            ...
            quitarCaracteres(objUsers[i].Rol) + "</td>");
        }else{
            tr.append(
        ...
        if(company){
            ...
            quitarCaracteres(objUsers[i].Compania) + "</td>");
        }else{
            tr.append(
        ...
        if(manager){
            ...
            quitarCaracteres(objUsers[i].Manager) + " " + quitarCaracteres(objUsers[i].SecondLastName) + "</td>");
        }else{
            tr.append(
