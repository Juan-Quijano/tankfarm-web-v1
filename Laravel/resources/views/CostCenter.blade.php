            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.Status == "OK") {
                                swal.fire("OK!", "COST CENTER UPDATED SUCCESSFULLY", "success");
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.Status == "OK") {
                            swal.fire("GOOD JOB!", "COST CENTER DISABLED SUCCESSFULLY!", "success");
                            llenarObjCentroCostos("", "");
                            UpdateContenedor('CostCenter');
                        }
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.Status == "OK") {
                            swal.fire("GOOD JOB!", "COST CENTER ENABLED SUCCESSFULLY!", "success");
                            llenarObjCentroCostos("", "");
                            UpdateContenedor('CostCenter');
                        }
                        if (data.Status == "ERROR") {
