            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        ...
                        <div class="form-check form-check-inline checkbox combosDias">
                            <input class="form-check-input inputPerfiles" type="checkbox" id="BRAND"
                                value="option2">
...
<table id="tablaC" class="table table-striped" cellspacing="0" width="100%"
        ...
        <tr>
            ...
            <tr>
                <th colspan=1 style="background: #233461; color: white; text-align: center;font-family:BMWTypeCondensedRegular;font-weight: bold;"></th>
        ...
        <tr>
            ...
            <th colspan=1 style="text-align: right;background: #233461;color:#fff"><img
            ...
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        console.log(data);
                        if (data.Status == "OK") {
                            swal.fire("OK! THE BRAND SAVED SUCCESSFULLY!", {
                                icon: "success",
                            });
                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        customize: function(doc) {
                           ...
                           age = Tabla_Marca.column(2).data().toArray();
...
function llenarTabla() {
    ...
    for (var i = 0; i < ObjMarca.length; i++) {
        ...
        if (pos == 0) {
            Tabla_Marca.row.add([
                String(quitarCaracteres(ObjMarca[i].MarcID)),
                String(quitarCaracteres(ObjMarca[i].MarcDesc)),
                String(colorStatus),
    ...
    Tabla_Marca.column('1:visible').draw();
}
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data.Status == "OK") {
                                swal.fire("OK!", "BRAND UPDATED SUCCESSFULLY", "success");
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.Status == "OK") {
                            swal.fire("GOOD JOB!", "BRAND DISABLED SUCCESSFULLY!", "success");
                            llenarObjMarca("");
                            UpdateContenedor('Marca');
                        }
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.Status == "OK") {
                            swal.fire("GOOD JOB!", "BRAND ENABLED SUCCESSFULLY!", "success");
                            llenarObjMarca("");
                            UpdateContenedor('Marca');
                        }
                        if (data.Status == "ERROR") {
...
pdfMake.createPdf(documentDefinition).download('BRAND_REPORT_"'+moment(new Date()).subtract(5, 'hours').format('MMMM,DD, YYYY')+'".pdf');
}
...
for (let index = 0; index < ObjMarca.length; index++) {
    if (id) {
        datos.push({
            text: quitarCaracteres(ObjMarca[index].MarcID),
            style: 'tableText'
        });
    }else{
        datos.push({
    ...
    if (brand) {
        datos.push({
            text: quitarCaracteres(ObjMarca[index].MarcDesc),
            style: 'tableText'
        });
    }else{
        datos.push({
    ...
    if (status) {
        var estatus="";
        if (ObjMarca[index].Status == 1) {
            estatus = "ENABLED";

            htmlBotonStatus = 'boton_danger';
            title = "DISABLED";
        } else if (ObjMarca[index].Status != 1) {
            htmlBotonStatus = 'boton_success';
            title = "ENABLED";
            estatus = "DISABLED";
        }
...
function descargarExcel(){
    ...
    link.download = "BRAND_REPORT_"+fecha+".xls";
...
var status = document.getElementById("STATUS").checked;
    ...
    for (var i = 0; i < ObjMarca.length; i++) {
        ...
        if(id){
            ...
            quitarCaracteres(ObjMarca[i].MarcID) + "</td> ");
        }else{
            tr.append(
        ...
        if(brand){
            ...
            quitarCaracteres(ObjMarca[i].MarcDesc) + "</td>");
        }else{
            tr.append(
