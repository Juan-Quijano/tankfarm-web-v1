...
<div class="x_panel" id="divEditarUsuario" >
    <div class="x_title">
        <h2>New Brand <small>Please complete all fields</small> </h2>
    ...
    <div class="x_content">
        ...
        <div class="col-md-6">
            <div id="divCombo1" class="form-group">
                ...
                <input type="text" class="form-control validar" onkeyup="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" name="Nombre2" id="Brand" placeholder="Brand">
    ...
    <div class="form-group row form-group row pull-left">
            <div class="col-md-12">
                ...
                <input type="button" value="Save" class="btn btn-success" id="SaveUserF"
...
<?php /**PATH C:\xampp\htdocs\TANKFARM\Laravel\resources\views/AddMarca.blade.php ENDPATH**/ ?>