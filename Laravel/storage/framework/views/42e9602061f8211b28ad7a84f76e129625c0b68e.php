                ...
                <form class="form-horizontal form-label-left">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-6" id="DivLastName">
                            <input type="text" name="last-name" required="required" class="form-control validar"  autocomplete="off"
                                id="LastName"
                                onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Second Last Name <span
                                class="required asterisco">*</span>
                        </label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-6" id="DivPass">
                            <input id="Password" class="form-control validar" required="required" type="password" autocomplete="off"
                                name="middle-name">
                        </div>
...
* Tiene que  tener al menos 1 número en su estructura." data-original-title="Ayuda"><img src="<?php echo e(url('/')); ?>/images/info_208px.png" alt="Girl in a jacket" width="30px" height="30px"></a>
                    ...
                    <div class="form-group row">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Confirm Password <span
                                class="required asterisco">*</span></label>
                        <div class="col-md-6 col-sm-6" id="DivPass1">
                            <input id="ConfirmPassword" class="form-control validar" required="required" type="password" autocomplete="off"
                                name="middle-name" onblur="validarPassword();">
                        </div>
                    </div>
                    ...
                    <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Password Security Level <span
                                class="required asterisco">*</span></label>
                ...
                <form class="form-horizontal form-label-left">
                    ...
                    <div class="form-group row" id="divCorreo">
                        ...
                        <div class="col-md-6 col-sm-6" id="DivEmail">
                            <input type="text" name="company" required="required" class="form-control validar" autocomplete="off"
                                id="Email">
...
function validateStep1() {
    ...
    for (let i = 0; i < inputs.length; i++) {
        ...
        if (inputs[i].id == "Name" ||inputs[i].id == "LastName"||inputs[i].id == "SecondLastName"|| inputs[i].id == "UserName" || inputs[i].id == "Password" || inputs[i].id == "ConfirmPassword" || inputs[i].id ==
            "department") {
            if (inputs[i].value == "") {
                $("#" + inputs[i].parentNode.id).removeClass("has-ok has-success");
                $("#" + inputs[i].parentNode.id).addClass("has-error has-danger");
            ...
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        console.log(data);
                        if (data.Status == "OK") {
                            swal("OK! THE USER SAVED SUCCESSFULLY!", {
                                icon: "success",
                            });
...
<?php /**PATH C:\xampp\htdocs\TANKFARM\Laravel\resources\views/AddUsuario.blade.php ENDPATH**/ ?>