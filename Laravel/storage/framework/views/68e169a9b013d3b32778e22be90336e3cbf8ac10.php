...
function llenarTabla() {
    ...
    for (var i = 0; i < ObjDrivers.length; i++) {
        ...
        if (pos == 0) {
            Tabla_Choferes.row.add([
                String(ObjDrivers[i].Company),
                String(ObjDrivers[i].Nombre +" " +ObjDrivers[i].LastName),
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.Status == "OK") {
                            swal("Good Job!", "Driver disabled succefull!", "success")
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.Status == "OK") {
                            swal("OK! DRIVER UPDATED SUCCESSFULLY!", {
                                icon: "success",
                            });
                            UpdateContenedor('Drivers');
                        } else {
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.Status == "OK") {
                            swal("GOOD JOB!", "DRIVER DISABLED SUCCESSFULLY!", "success")
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.Status == "OK") {
                            swal("GOOD JOB!", "DRIVER ENABLED SUCCESSFULLY!", "success")
...
<?php /**PATH C:\xampp\htdocs\Laravel\resources\views/Drivers.blade.php ENDPATH**/ ?>