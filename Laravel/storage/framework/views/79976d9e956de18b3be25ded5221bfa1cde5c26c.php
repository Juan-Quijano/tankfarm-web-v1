        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-form-title" style="background-image: url(images/logb.webp);">
                    ...
                    <div class="login-box">
                        <img src="<?php echo e(url('/')); ?>/images/BMW_White-Colour_RGB.svg" class="avatar" alt="Avatar Image">
...
-->
    ...
    <!--===============================================================================================-->
    <script src="<?php echo e(url('/')); ?>/dist/js/jquery-3.5.1.js" crossorigin="anonymous"></script>
    <!--===============================================================================================-->
    ...
    <script src="<?php echo e(url('/')); ?>/js/crypto-js.min.js"></script>
    <script src="<?php echo e(url('/')); ?>/js/hmac-sha512.js"></script>
...
var IPWS = "<?php echo e(url('/')); ?>".replace(":90/TANKFARM", "")+":83/api/Login/";
...
function IniciarSesion() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            usuario = data;
            usuario._token ="<?php echo e(csrf_token()); ?>";
            msj = data.Status;
    ...
    if (msj == "FOUND" || msj === null) {
        ...
        var sURL = "<?php echo e(url('/')); ?>/setLogin";
        $.ajax({
            url: sURL,
            dataType: "json",
            type: "POST",
...
<?php /**PATH C:\xampp\htdocs\TANKFARM\Laravel\resources\views/Login2.blade.php ENDPATH**/ ?>