...
<html lang="en">
  ...
  src: url("<?php echo e(url('/')); ?>/dashboard/assets/fonts/glyphicons-halflings-regular.eot?#iefix") format("embedded-opentype"), url("<?php echo e(url('/')); ?>/dashboard/assets/fonts/glyphicons-halflings-regular.woff") format("woff"), url("<?php echo e(url('/')); ?>/dashboard/assets/fonts/glyphicons-halflings-regular.ttf") format("truetype"), url("<?php echo e(url('/')); ?>/dashboard/assets/fonts/glyphicons-halflings-regular.svg#glyphicons-halflingsregular") format("svg"); }
  ...
  <script src="<?php echo e(url('/')); ?>/vendors/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
   ...
   <link href="<?php echo e(url('/')); ?>/vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css" rel="stylesheet">
    ...
    <script type="text/javascript" src="<?php echo e(url('/')); ?>/js/echarts.min.js"></script>
  <body class="nav-md" style="FONT-FAMILY: BMWTypeCondensedRegular;">
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
              <div class="navbar nav_title" style="border: 0;">
                  <a href="<?php echo e(url('/')); ?>" class="site_title"><img src="<?php echo e(url('/')); ?>/images/Logo_Web_1_Launcher.png" style="height: 45px;"></a>
              </div>
                            ...
                            <ul class="nav side-menu">
                                <li class=""><a><i class="fa fa-home"></i> Settings <span
                                    ...
                                    <ul class="nav child_menu" >
                                        <li  id="menu_company" style="display:none" class=""><a>Company<span class="fa fa-chevron-down"></span></a>
                                            ...
                                            <li><a href="javascript:UpdateContenedor('AddCustomer');">New Company</a></li>
                                            <li><a href="javascript:UpdateContenedor('Customers');">Edit Company</a></li>
                                            </ul>
                                        </li>
                                        <li  id="menu_Users" style="display:none" class=""><a>Users<span class="fa fa-chevron-down"></span></a>
                                            <ul class="nav child_menu" style="display: block;">
                                                <li id="liuser" style="display:none"><a href="javascript:UpdateContenedor('users');">New User</a></li>
                                                <li id="lirole" style="display:none"><a href="javascript:UpdateContenedor('Roles');">New Role</a></li>
                                            </ul>
                                        </li>
                                        <li  id="lidriver" style="display: none" class=""><a>Drivers<span class="fa fa-chevron-down"></span></a>
                                            <ul class="nav child_menu" style="display: block;">
                                                <li id="lidriver1"style="display:none"><a href="javascript:UpdateContenedor('AddDriver');">New Driver</a></li>
                                                <li id="lidriver2"style="display:none"><a href="javascript:UpdateContenedor('Drivers');">Edit Driver</a></li>
                                            </ul>
                                        </li>
                                        <li  id="menu_Vehicles" style="display: none" class=""><a>Vehicles<span class="fa fa-chevron-down"></span></a>
                                            <ul class="nav child_menu" style="display: block;">
                                            <li id="livehicle1" style="display:none"><a href="javascript:UpdateContenedor('AddVehicle');">New Vehicle</a></li>
                                                <li id="livehicle2" style="display:none"><a href="javascript:UpdateContenedor('Vehicles');">Edit Vehicle</a></li>
                                            </ul>
                                        </li>
                                        <li  id="liProfile" style="display: none" class=""><a>Profile<span class="fa fa-chevron-down"></span></a>
                                            <ul class="nav child_menu" style="display: block;">
                                            <li id="liProfile1" style="display:none"><a href="javascript:UpdateContenedor('AddPerfiles');">New Profile</a></li>
                                                <li id="liProfile2" style="display:none"><a href="javascript:UpdateContenedor('Perfiles');">Edit Profile</a></li>
                                              
                                            </ul>
                                        </li>
                                        <li  id="librand" style="display: none" class=""><a>Brand<span class="fa fa-chevron-down"></span></a>
                                            <ul class="nav child_menu" style="display: block;">
                                            <li id="librand1" style="display:none"><a href="javascript:UpdateContenedor('AddMarca');">New Brand</a></li>
                                                <li id="librand2" style="display:none"><a href="javascript:UpdateContenedor('Marca');">Edit Brand</a></li>
                                            </ul>
                                        </li>
                                        <li  id="limodal" style="display: none" class=""><a>Model<span class="fa fa-chevron-down"></span></a>
                                            <ul class="nav child_menu" style="display: block;">
                                            <li id="limodal1" style="display:none"><a href="javascript:UpdateContenedor('AddModel');">New Model</a></li>
                                                <li id="limodal2" style="display:none"><a href="javascript:UpdateContenedor('Model');">Edit Model</a></li>
                                            </ul>
                                        </li>
                                        <li  id="lidepartment" style="display: none" class=""><a>Department<span class="fa fa-chevron-down"></span></a>
                                            <ul class="nav child_menu" style="display: block;">
                                            <li id="lidepartment1"style="display:none"><a href="javascript:UpdateContenedor('AddDepartment');">New Department</a></li>
                                                <li id="lidepartment2"style="display:none"><a href="javascript:UpdateContenedor('Department');">Edit Department</a></li>
                                            </ul>
                                        </li>
                                        <li  id="liCentroCostos" style="display: none" class=""><a>Cost Center<span class="fa fa-chevron-down"></span></a>
                                            <ul class="nav child_menu" style="display: block;">
                                            <li id="liCentroCostos1"style="display:none"><a href="javascript:UpdateContenedor('AddCostCenter');">New Cost Center</a></li>
                                                <li id="liCentroCostos2"style="display:none"><a href="javascript:UpdateContenedor('CostCenter');">Edit Cost Center</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li><a><i class="fa fa-tachometer"></i> Consumption Reports<span
                                    ...
                                    <ul class="nav child_menu" style="">
                                        ...
                                        <li><a href="javascript:UpdateContenedor('ReportFuel2');">Fuel Dispenser 2 (TGF)</a></li>
                                        <li><a href="javascript:UpdateContenedor('FuelGeneralReport');">Global Totals Report</a></li>
                                    </ul>
                                </li>
                                ...
                                <li  id="menuConfiguracion" style="display: none"><a><i class="fa fa-cog"></i> Settings <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="">
                                        <li><a href="javascript:UpdateContenedor('Configuracion');">Edit Settings</a></li>
              ...
              <div class="sidebar-footer hidden-small">
                  ...
                  <a href="https://www.tdcon40.com" style="    background: #2a3f54;">  <img
                          ...
                          style="margin-left: 20%;/* width: 58%; */"></a><h5 style="margin-top: -11px;margin-left: 96px; color:white;">Powered By<h5>
              </div>
              <!-- /menu footer buttons -->
                ...
                <ul class=" navbar-right">
                  <li class="nav-item dropdown open" style="padding-left: 15px;">
                    ...
                    <a class="dropdown-item"  href="javascript:;">Help</a>
                      <a class="dropdown-item"  href="<?php echo e(url('/cerrarSesion')); ?>"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                    </div>
                  </li>
...
<script>
          ...
          var IPSERVIDOR = "<?php echo e(url('/')); ?>".replace(":83", "");
...
<?php /**PATH C:\xampp\htdocs\Laravel\resources\views/header.blade.php ENDPATH**/ ?>