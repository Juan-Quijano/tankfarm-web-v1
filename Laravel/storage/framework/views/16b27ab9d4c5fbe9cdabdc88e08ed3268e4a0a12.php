...
<div class="row">
    <div class="column">
        <div class="card">
            <a href="<?php echo e(url('/cerrarSesion')); ?>">
                <p><img src="<?php echo e(url('/images/login.png')); ?>" alt="Avatar" style="width:100px;height:100px;"></p>
                <h3>LOG OUT</h3>
            </a>
    ...
    <div class="column">
        <div class="card">
            <a href="javascript:UpdateContenedor('FuelTankLevel');">
                <p> <img src="<?php echo e(url('/images/level.png')); ?>" alt="Avatar" style="width:100px;height:100px;"></p>
    ...
    <div class="column">
        <div class="card">
            <a href="javascript:UpdateContenedor('Reporte1');">
                <p> <img src="<?php echo e(url('/images/graficas.png')); ?>" alt="Avatar" style="width:100px;height:100px;"></p>
...
</script><?php /**PATH C:\xampp\htdocs\TANKFARM\Laravel\resources\views/inicio.blade.php ENDPATH**/ ?>