...
<!-- jQuery Tags Input <script src="<?php echo e(url('/')); ?>/vendors/jquery.hotkeys/jquery.hotkeys.js"></script><script src="<?php echo e(url('/')); ?>/vendors/bootstrap-wysiwyg/js/bootstrap-wysiwyg.min.js"></script><script src="<?php echo e(url('/')); ?>/vendors/bootstrap-wysiwyg/js/bootstrap-wysiwyg.min.js"></script>-->
...
<script src="<?php echo e(url('/')); ?>/dist/vendors/bower_components/jquery.steps/build/jquery.steps.min.js"></script>
<!-- Parsley -->

<!-- Autosize <script src="<?php echo e(url('/')); ?>/dist/js/form-wizard-data.js"></script>-->
...
<script src="<?php echo e(url('/')); ?>/vendors/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
...
<script src="<?php echo e(url('/')); ?>/dashboard/dist/js/sweetalert.min.js"></script>
  ...
  <?php /**PATH C:\xampp\htdocs\TANKFARM\Laravel\resources\views/librerias.blade.php ENDPATH**/ ?>