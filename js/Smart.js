function SmartWizard(target, options) {
    ...
    var _init = function($this) {
        ...
        $('.actionBar').append(
            "<button type='input' onclick='savecustomerss();' id='Save_Customer'class='btn btn-round' style='color:white;' >Save<span class='glyphicon glyphicon-chevron-right'></span></button>"
        );
        $("#Save_Customer").css({
            'background': '#26B99A'
        });
